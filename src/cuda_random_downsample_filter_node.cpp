...
#include "cuda_pointcloud_filters/cuda_random_downsample_filter_node.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(cuda_pointcloud_filters::CudaRandomDownsampleFilterNode)
